...
public class MenuScreen extends StackPane {
    ...
    public MenuScreen(Stage stage) {
        ...
        // Menu buttons
        Button startBtn = new MenuButton("Start Game", e -> menuController.startGame());
        Button optionsBtn = new MenuButton("Options", e -> menuController.openSettings());
        Button exitBtn = new MenuButton("Exit", e -> menuController.quitGame());
